...
if not __package__:  # pragma: no cover
    ...
    # - `python path/to/this/repo/src/hatch_python_project_template/main.py`   from anywhere,
    # - `hatch run python src/hatch_python_project_template/main.py`           from the root of this repo,
    sys.path.insert(0, str(Path(__file__).parents[1]))


from hatch_python_project_template.utils.utils import (
    LogLevel,
    add_file_handler,
    get_ordinal_suffix,
